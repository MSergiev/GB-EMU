...
inline void process( BYTE inst ) {
    ...
    switch( inst ) {
        ...
        case 0x12: LD ( WPADDR(*DE), A ); break;
        ...
        case 0x1A: LD ( A, WPADDR(*DE) ); break;
        ...
        case 0x22: LD ( WPADDR(*HL), A ); (*HL)++; break;
        ...
        case 0x2A: LD ( A, WPADDR(*HL) ); (*HL)++; break;
        ...
        case 0x32: LD ( WPADDR(*HL), A ); (*HL)--; break;
        case 0x33: INC ( &SP ); break;
        case 0x34: INC ( WPADDR(*HL) ); break;
        case 0x35: DEC ( WPADDR(*HL) ); break;
        case 0x36: LD ( WPADDR(*HL), BPIM() ); break;
        case 0x37: SCF (); break;
        case 0x38: JR ( GFC(), BPIM() ); break;
        case 0x39: ADD ( HL, &SP ); break;
        case 0x3A: LD ( A, WPADDR(*HL) ); (*HL)--; break;
        ...
        case 0x46: LD ( B, WPADDR(*HL) ); break;
        ...
        case 0x4E: LD ( C, WPADDR(*HL) ); break;
        ...
        case 0x56: LD ( D, WPADDR(*HL) ); break;
        ...
        case 0x5E: LD ( E, WPADDR(*HL) ); break;
        ...
        case 0x66: LD ( H, WPADDR(*HL) ); break;
        ...
        case 0x6E: LD ( L, WPADDR(*HL) ); break;
        case 0x6F: LD ( L, A ); break;
        
        case 0x70: LD ( WPADDR(*HL), B ); break;
        case 0x71: LD ( WPADDR(*HL), C ); break;
        case 0x72: LD ( WPADDR(*HL), D ); break;
        case 0x73: LD ( WPADDR(*HL), E ); break;
        case 0x74: LD ( WPADDR(*HL), H ); break;
        case 0x75: LD ( WPADDR(*HL), L ); break;
        case 0x76: HALT(); break;
        case 0x77: LD ( WPADDR(*HL), A ); break;
        ...
        case 0x7E: LD ( WPADDR(*HL), A ); break;
        ...
        case 0x86: ADD ( A, BPADDR(*HL) ); break;
        ...
        case 0x8E: ADC ( A, BPADDR(*HL) ); break;
        ...
        case 0x96: SUB ( A, BPADDR(*HL) ); break;
        ...
        case 0x9E: SBC ( A, BPADDR(*HL) ); break;
        ...
        case 0xE0: LD ( BPADDR(0xFF00+*BPIM()), A ); break;
        case 0xE1: POP ( HL ); break;
        case 0xE2: LD ( BPADDR(0xFF00+*C), C ); break;
        case 0xE3: ERR(); break;
        case 0xE4: ERR(); break;
        ...
        case 0xE9: JP ( 1, WPADDR(*HL) ); break;
        case 0xEA: LD ( WPADDR(*WPIM()), A ); break;
        case 0xEB: ERR(); break;
        case 0xEC: ERR(); break;
        case 0xED: ERR(); break;
        ...
        case 0xF0: LD ( A, BPADDR(0xFF00+*BPIM()) ); break;
        ...
        case 0xFA: LD ( A, WPADDR(*WPIM()) ); break;
        case 0xFB: EI (); break;
        case 0xFC: ERR(); break;
        case 0xFD: ERR(); break;
